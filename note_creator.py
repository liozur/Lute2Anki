...
class NoteCreator:
    ...
    def create_cards(self, terms: List, selected_lang: str) -> int:
        ...
        try:
            ...
            log_info(
                f"[note_creator] Total {counter} cards successfully added to deck {self.deck_name}"
            )
            return counter
    ...
    def _create_note(self, term, adjust_ease: bool) -> Optional[Note]:
        ...
        try:
            ...
            # note.fields[1] = term[1].replace("【..】", "<br><br>\0<br>")
    ...
    def _add_note_to_deck(self, note: Note, term, deck_id: int, counter: int) -> int:
        ...
        try:
            ...
            log_error(
                f"[note_creator] Error creating note for term {term[0]}: {str(e)}"
            )
            return counter
